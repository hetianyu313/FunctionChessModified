...
class AIController {
    ...
    async selectTargets() {
        ...
        const count = this.gameController.getAiTargetCountLimit();
    ...
    setForbiddenZones() {
        const state = this.gameController.getGameState();
        const maxForbidden = this.gameController.getAiForbiddenCountLimit();
        const gridSize = this.gridSystem.gridSize;
    ...
    setLocks() {
        const state = this.gameController.getGameState();
        const maxLocks = this.gameController.getAiLockCountLimit();
